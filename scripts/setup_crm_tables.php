...
function crm_setup_create(): array
{
    ...
    $sql[] = "CREATE TABLE IF NOT EXISTS crm_tasks (
        ...
        task_type VARCHAR(20) DEFAULT 'Logged',
        ...
        task_latitude DECIMAL(10, 8) NULL,
        task_longitude DECIMAL(11, 8) NULL,
        attachment TEXT NULL,
        task_proof_image TEXT NULL,
    ...
    if ($ok) {
        $columnStatements = [
            ...
            'tasks_task_type' => "ALTER TABLE crm_tasks ADD COLUMN task_type VARCHAR(20) DEFAULT 'Logged' AFTER created_by",
            'tasks_task_date' => "ALTER TABLE crm_tasks ADD COLUMN task_date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER task_type",
            'tasks_outcome' => "ALTER TABLE crm_tasks ADD COLUMN outcome TEXT NULL AFTER status",
            'tasks_status_cancelled' => "ALTER TABLE crm_tasks MODIFY COLUMN status ENUM('Pending','In Progress','Completed','Cancelled') NOT NULL DEFAULT 'Pending'",
            'tasks_priority' => "ALTER TABLE crm_tasks ADD COLUMN priority ENUM('Low','Medium','High') NOT NULL DEFAULT 'Medium' AFTER due_date",
            'tasks_task_proof_image' => "ALTER TABLE crm_tasks ADD COLUMN task_proof_image TEXT NULL AFTER attachment",
            'tasks_task_latitude' => "ALTER TABLE crm_tasks ADD COLUMN task_latitude DECIMAL(10, 8) NULL AFTER longitude",
            'tasks_task_longitude' => "ALTER TABLE crm_tasks ADD COLUMN task_longitude DECIMAL(11, 8) NULL AFTER task_latitude",
            'tasks_completion_notes' => "ALTER TABLE crm_tasks ADD COLUMN completion_notes TEXT NULL AFTER outcome",
            ...
            'tasks_lead_id_not_null' => "ALTER TABLE crm_tasks MODIFY COLUMN lead_id INT NOT NULL",
    ...
    if ($ok) {
        $indexStatements = [
            ...
            'idx_tasks_task_type' => "ALTER TABLE crm_tasks ADD INDEX idx_task_type (task_type)",
            'idx_tasks_task_date' => "ALTER TABLE crm_tasks ADD INDEX idx_task_date (task_date)",
