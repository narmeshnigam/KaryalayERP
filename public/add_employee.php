...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (count($errors) == 0) {
        ...
        $insert_query = "INSERT INTO employees (
            employee_code, first_name, middle_name, last_name, date_of_birth, gender, blood_group, marital_status, nationality,
        ...
        mysqli_stmt_bind_param($stmt, 'sssssssssssssssssssssssssssissssdddddddsssssssssssssssssddssssi',
            ...
            !empty($_POST['reporting_manager_id']) ? $_POST['reporting_manager_id'] : null,
            $_POST['work_location'] ?? null,
            $_POST['shift_timing'] ?? null,
            $_POST['probation_period'] ?? 90,
            ...
            !empty($_POST['year_of_passing']) ? $_POST['year_of_passing'] : null,
            $_POST['previous_company'] ?? null,
            $_POST['previous_designation'] ?? null,
            !empty($_POST['previous_experience_years']) ? $_POST['previous_experience_years'] : 0,
            !empty($_POST['total_experience_years']) ? $_POST['total_experience_years'] : 0,
            $_POST['status'] ?? 'Active',
            $_POST['skills'] ?? null,
