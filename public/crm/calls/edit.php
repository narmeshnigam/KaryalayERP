...
<style>
.call-edit-header-flex{display:flex;justify-content:space-between;align-items:center;gap:16px;flex-wrap:wrap;}
.call-edit-header-buttons{display:flex;gap:8px;flex-wrap:wrap;}
.call-edit-form-grid-3{display:grid;grid-template-columns:repeat(3,1fr);gap:20px;}
.call-edit-form-grid-1{display:grid;grid-template-columns:1fr;gap:20px;}

@media (max-width:1024px){
.call-edit-form-grid-3{grid-template-columns:repeat(2,1fr);}
}

@media (max-width:768px){
.call-edit-header-flex{flex-direction:column;align-items:stretch;}
.call-edit-header-buttons{width:100%;flex-direction:column;gap:10px;}
.call-edit-header-buttons .btn{width:100%;text-align:center;}
.call-edit-form-grid-3{grid-template-columns:1fr;}
}

@media (max-width:480px){
.call-edit-header-flex h1{font-size:1.5rem;}
.call-edit-form-grid-3{gap:15px;}
}
</style>
...
<div class="main-wrapper">
  <div class="main-content">
    ...
    <div class="page-header">
      <div class="call-edit-header-flex">
        <div>
          <h1>✏️ Edit Call</h1>
          <p>Update call details, ownership, and follow-up</p>
        </div>
        <div class="call-edit-header-buttons">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="card" style="margin-bottom: 25px;">
            ...
            <div class="call-edit-form-grid-3">
