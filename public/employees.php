<?php
/**
 * Employee Management Module - Main Page
 * Lists all employees with search, filter, and CRUD operations
 */
    ...
    <div class="main-content">
        ...
        <?php else: ?>
            ...
            <div class="card" style="margin-bottom: 25px;">
                <form method="GET" action="employees.php" style="display: grid; grid-template-columns: 2fr 1fr 1fr auto; gap: 15px; align-items: end;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        ...
                        <a href="employees.php" class="btn btn-accent" style="white-space: nowrap; text-decoration: none; display: inline-block; text-align: center;">Clear</a>
                    </div>
                </form>
            </div>
            ...
            <div class="card">
                ...
                <?php else: ?>
                    <div style="text-align: center; padding: 60px 20px; color: #6c757d;">
                        ...
                        <a href="employees.php" class="btn btn-accent" style="margin-top: 20px; text-decoration: none;">Clear Filters</a>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
